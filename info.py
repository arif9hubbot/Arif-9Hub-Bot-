...
#main variables
API_ID = int(environ.get('API_ID', '25347668'))
API_HASH = environ.get('API_HASH', '662102ad7a61eb3ea4d339fbfea9e05f')
BOT_TOKEN = environ.get('BOT_TOKEN', '8044588137:AAFJj-lv0azpsRSle4_98O867REoUzM2M24')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5737399804').split()]
USERNAME = environ.get('USERNAME', "")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002459208059'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+2mm2SWvTCPJlNDZl')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002294985926').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mdarif7811919523:MtPbFD5j7zuYNslT@cluster0.m1nle.mongodb.net/")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002320755700'))
QR_CODE = environ.get('QR_CODE', '')
START_IMG = environ.get('START_IMG', 'https://telegra.ph/file/3790a1af20ac3fa22729f.jpg')
